...
class FillPermissionsForLicence extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLicence constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.licence',
            'admin.licence.index',
            'admin.licence.create',
            'admin.licence.show',
            'admin.licence.edit',
            'admin.licence.delete',
            'admin.licence.bulk-delete',
        ]);
